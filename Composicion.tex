...
\end{inparaenum} \\
Esta sección va a estar enfocada en la definición de composición total de autómatas y la noción de que dado un conjunto $\{ \mathcal{A}_i\}_{i \in I}$ de AFCA sin transiciones de buffer la semántica de la composición es equivalente a la del conjunto de mCFSM proyectadas de los elementos de $\{ \mathcal{A}_i\}_{i \in I}$. 

\xymatrix{   
	\{\mathcal{A}_i\}_{i \in I} \ar[r]_{\Pi} \ar[d]_{||} & \{C_i\}_{i \in I}  \ar[dr]_{semántica}  \\
...
\begin{itemize}
    ...
    % \item Sea $T_i$ mCFSM =  $\langle Q, \mathcal{C}, q_0, \mathcal{M}, \delta \rangle$
    % \item Sea $\mathcal{L}$ el LTS $ $
\end{itemize}
\end{definition}
