...
\cnote{Explicar cómo los autómatas ejemplifican la comunicación referenciando la Fig.~\ref{a_i}.}
...
\end{tikzpicture} 
\end{center}
\caption{Autómatas finitos de comunicación asincrónica $\mathcal{A}_1$, $\mathcal{A}_2$, $\mathcal{A}_3$.}
\label{a_i}
\end{figure}
...
\cnote{Explicar el ejemplo referenciando la Fig.~\ref{m_i}.}
