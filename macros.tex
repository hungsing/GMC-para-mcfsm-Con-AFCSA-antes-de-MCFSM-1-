...
\newcommand{\anote}[1]{\todo[fancyline,color=LavanderPosta]{#1 \\{\footnotesize(Agus)}}\xspace{}}
...
\newcommand\HeteroGenius{{{\ffmfamily Hetero}{\LobsterTwo Genius}}}
\newcommand\SEArch{{\ECFAugie SEArch}}
\newcommand\SEArchComp{{\ECFAugie SEArch -- Service Execution Architecture}}
