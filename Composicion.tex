...
\begin{enumerate}
\item $\delta_{\mathcal{P}\mathit{Int}} = \{ \langle q, \sigma, q' \rangle \ | \ q,q' \in Q_{\mathcal{P}}, \sigma \in \Sigma_{\mathcal{P}\mathit{Int}} \land \exists E_{p_i} \land \langle q_{p_i},\sigma_{p_i},q'_{p_i} \rangle \in \delta_{p_i Int} \}$ es la relación de transición interna
\item $\delta_{\mathcal{P}\mathit{Ex}} = \{ \langle q, \sigma, q' \rangle \ | \ q,q' \in Q_{\mathcal{P}}, \sigma \in \{\mathit{In}(e,m), \mathit{Out}(e,m) | e \in \Sigma_{\mathcal{P}\mathit{Ex}} \land m \in \mathcal{M}\} \land \exists E_{p_i} \land \langle q_{p_i}, \sigma_{p_i}, q'_{p_i} \rangle \in \delta_{p_i{\mathit{Ex}}} \}$, es la relación de transición de comunicación externa de $E_\mathcal{P}\} $, y 
\item $\delta_{\mathcal{P}\mathit{Buff}} = \{ \langle q, \sigma, q' \rangle \ | \ q,q' \in Q_{\mathcal{P}}, \sigma \in \Sigma_{\mathcal{P}\mathit{Buff}} \land \exists E_{p_i} \land \langle q_{p_i},\sigma_{p_i},q'_{p_i} \rangle \in \delta_{p_i Buff} \}$  y decimos que $\forall q \in Q_\mathit{\mathcal{P}}, \ m \in \mathcal{M} \ |	 \ \langle q, [\omega_\mathit{b}]_{b \in B_\mathcal{P}} \gg m, q' \rangle \in \delta_\mathit{\mathcal{P}Buff} \iff \exists$ una configuración $ \langle q, [\omega_\mathit{b},...,\omega_\mathit{b}:m, ..., \omega_\mathit{b}] \rangle$
\end{enumerate}
