...
\begin{itemize}
    \item $\forall $ Cada estado de $n$ de $\mathcal{L}'$ corresponde a una configuración $\langle q, \Omega \rangle$ de $\mathcal{A}$ y
    \item Un estado $n$ es alcanzable desde otro estado $n'$ sii $\exists \langle q, \sigma, q' \rangle \in \delta_{\mathcal{A}}$ con $\sigma \in \Sigma_{Buff}$
