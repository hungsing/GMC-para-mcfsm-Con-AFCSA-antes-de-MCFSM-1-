...
\begin{definition}[Multichannel Communicating Finite State Machine - mCFSM]\label{mCFSM} Una multichannel communicating finite state machine (mCFSM) sobre $\mathcal{M}$ es un sistema finito de transición $(Q, \mathcal{C}, q_0, \mathcal{M}, \delta)$ donde
\begin{itemize}
  \item $Q$ es un conjunto finito de estados
