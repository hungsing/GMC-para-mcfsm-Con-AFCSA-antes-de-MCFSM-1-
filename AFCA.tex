...
El objetivo principal de esta clase de autómatas es posibilitar la composición parcial de componentes de un sistema, como idea de que sirva de reconfiguración dinámica del mismo. Esto debiera visibilizarse a partir de poder, dado un conjunto de AFCAs, tomar un subcjto y componerlo, y que el resultado siga siendo un conjunto de AFCAs que puede ser compuesto a su vez. En la Fig.~\ref{a_i} vemos un conjunto de tres AFCA compatibles para la composición. Tomando este mismo conjunto podemos elegir componer solo dos y nos seguiría quedando un conjunto de AFCAs compatibles, como podemos ver en la Fig.~\ref{A-parcial} con el autómata compuesto $\mathcal{A}_{PR}$ y el autómata $S$.
