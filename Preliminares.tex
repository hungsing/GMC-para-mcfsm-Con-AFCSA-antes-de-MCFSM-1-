...
\begin{definition}[Relacionres y clausuras] 
...
\end{itemize}
$S$ se dice que es la \emph{clausura reflexiva y transitiva} si $S = R^0 \cup R^*$ y se dice que es la \emph{clausura reflexiva, simétrica y transitiva} si $S = R^0 \cup R^{-1} \cup R^*$. Cuando una relación es reflexiva, simétrica y transitiva se dice que es una \emph{equivalencia}.
\end{definition}
