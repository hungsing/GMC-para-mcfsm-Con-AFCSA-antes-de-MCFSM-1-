...
\begin{enumerate}
    ...
    \item \label{ex:cond3} No vale $ ((q_0, sr!a,q1) \underline{\Diamond} (q_1,sr'!a,q5))$ %porque la transición entre $q_0$ y $q_1$ pasa a través de $sr!a$. Es decir que las dos transiciones son secuenciales no concurrentes. 
