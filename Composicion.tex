...
\qquad
\begin{array}{l}
(\exists p_i \in \mathcal{P})(\exists \widehat{q}, \widehat{q'} \in Q_{p_i}, \sigma \in \Sigma_{{p_i} \mathit{Buff}})((\forall p_k \in \mathcal{P})(p_k \neq p_i \implies q_k = q'_k) \land \\
\qquad  q_i = \widehat{q} \land q'_i = \widehat{q'} \land \sigma = \omega_b \{\gg, \ll\} m \land \omega_b \in B_{p_i}) \lor\\
