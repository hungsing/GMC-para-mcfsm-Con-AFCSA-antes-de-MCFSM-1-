...
\begin{itemize}
    ...
    % definición de cociente de comunicación, no se si tiene sentido copiarla tal cual \{\overrightarrow{q}' \in Q | \overrightarrow{q} \xrightarrow{\sigma^*} \overrightarrow{q'} \land \sigma  \in  \Sigma_{Int}\}
