...
\cnote{Escribir cómo los AFCAs posibilitan composición parcial y explicar referenciando la Fig.~\ref{A-parcial}.}

\cnote{Componer $\mathcal{A}_1$ y $\mathcal{A}_2$ y dejar $\mathcal{A}_3$ como está.}
