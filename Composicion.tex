...
\begin{itemize}
    ...
    \begin{inparaenum}[1)]
        ...
        \item $\Sigma_{\mathcal{P}\mathit{Ex}} = \bigcup \Sigma_{p_i\mathit{Ex}} \setminus \Sigma_\mathit{p_ifromtop_j}$ y 

        \item $\Sigma_{\mathcal{P}\mathit{Buff}} = \bigcup \Sigma_{p_i\mathit{Buff}} \cup \Sigma_\mathit{p_ifromtop_j}$ donde

        \item $\Sigma_\mathit{\mathcal{P}_ifromto\mathcal{P}_j} =\{ \langle p_i,p_j,c \rangle \ | \ p_i,p_j \in \mathcal{P}, \  c \in \mathcal{C}_{p_i} \cap \mathcal{C}_{p_j}\} $
    \end{inparaenum}
